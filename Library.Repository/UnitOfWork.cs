...
namespace Library.Repository {
  public sealed class UnitOfWork {
    ...
    private readonly Lazy<PositionsRepository> _positionRepository;
    ...
    public UnitOfWork() {
      ...
      _positionRepository = new Lazy<PositionsRepository>(() => new PositionsRepository(_database));
    }
    ...
    public PositionsRepository PositionRepository => _positionRepository.Value;
  }
}